...
from forms import form_crear_usuario, form_editar_usuario, form_crear_habitacion, form_editar_habitacion, \
    form_crear_administrador, form_editar_admin, form_crear_superAdmin, form_editar_superAdmin, form_reservacion
...
def agregar_superAdmin():
    ...
    if request.method == 'POST':
        ...
        return render_template('index_superAdmin.html', t_superAdmin=lista_superAdmin,
                               titulo="Registro super Administradores")
...
def editar_superAdmin(id):
    if request.method == 'GET':
        ...
        return render_template('editar_superAdmin.html', datos=admin, form=form,
                               titulo="Editar super administrador " + id)
    if request.method == 'POST':
        nombre = request.form["nombre"]
        cedula = request.form["cedula"]
        correo = request.form["correo"]
